...
var draw_config = require('../../draw_config');
...
class Draw_Player {
    static draw(player, graph, global, offset = {x: 0, y:0}) {
        ...
        graph.lineWidth = draw_config.playerBorder;
        ...
        graph.lineWidth = draw_config.playerTextBorderSize;
        graph.fillStyle = draw_config.playerTextColor;
        graph.strokeStyle = draw_config.playerTextBorder;
        graph.miterLimit = 1;
        graph.lineJoin = 'round';
    ...
    static drawFromJSON(player, graph, global, offset = {x: 0, y:0}) {
